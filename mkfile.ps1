...
if (-not ($size -and $fname)) {
    ...
    Write-Host ""
    Write-Host ".SYNOPSIS"
    Write-Host "Creates a dummy file with the specified size and name in the specified directory."
    Write-Host ""
    Write-Host ".DESCRIPTION"
    Write-Host "This script creates a dummy file with random content of the specified size and name in the specified directory."
    Write-Host ""
    Write-Host ".PARAMETER size"
    Write-Host "The size of the dummy file in bytes."
    Write-Host ""
    Write-Host ".PARAMETER path"
    Write-Host "The path to the directory where the dummy file will be created."
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "This example creates a dummy file named mydummyfile.txt with a size of 1048576 bytes in the specified directory."
    Write-Host ""
    exit
}
